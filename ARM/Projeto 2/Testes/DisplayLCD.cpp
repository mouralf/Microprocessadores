...
//função utilizada para zerar o valor da quilometragem, já que é o único que faz sentido de ser zerado...
...
int main() {
     printf("Hello world!\n");
        ...
        btnConfig.fall(&ConfiguraValores);  //interrupção chamada para zerar a quilometragem
